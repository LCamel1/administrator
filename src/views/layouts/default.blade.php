...
<link href="{{ asset('wangeditor/style.css') }}" rel="stylesheet">
	<link href="{{ asset('administrator/css/app.css') }}" media="all" type="text/css" rel="stylesheet">
	<link href="{{ asset('administrator/css/main-extended.css') }}" media="all" type="text/css" rel="stylesheet">

	<!--[if lte IE 9]>
		<link href="{{ asset('administrator/css/browsers/lte-ie9.css')}}" media="all" type="text/css" rel="stylesheet">
	<![endif]-->
...
<body>
	...
	<script src="{{ asset('administrator/js/base.js' )}}"></script>
	@foreach ($myjs as $url)
